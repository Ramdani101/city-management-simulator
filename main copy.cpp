...
void campaignMode()
{
    ...
    {
        eventDinamis(hariEvent, hariTerkini, &pendapatan);
        ...
        {
            setColor(6);
            cout << "Interaksi : " << sisaInteraksi << endl;
            tampilanPilihan();
            setColor(1);
            cout << "Pilihan : ";
            setColor(7);
...
void tampilanPilihan()
{
    ...
    cout << "1. ";
    setColor(7);
    cout << "Bangun Fasilitas (interaksi -1) \n";
    setColor(4);
    cout << "2. ";
    setColor(7);
    cout << "Terapkan Kebijakan (interaksi -1) \n";
    setColor(4);
    cout << "3. ";
    setColor(7);
    cout << "Robohkan Fasilitas (interaksi -1) \n";
    setColor(4);
    cout << "4. ";
    setColor(7);
    cout << "Lihat Peta Kota \n";
    setColor(4);
    cout << "5. ";
    setColor(7);
    cout << "Lihat Jumlah Fasilitas \n";
    setColor(4);
    cout << "6. ";
    setColor(7);
    cout << "Statistik Populasi \n";
    setColor(4);
    cout << "7. ";
    setColor(7);
    cout << "Akhiri Hari \n";
...
void eventDinamis(int *hariEvent, int hariTerkini, int *pendapatan)
{
    int respon;
    bool isBreak;
    if (hariEvent[0] == hariTerkini)
    {
        printDengan2GarisBawah("Perhatian !!! Banjir bandang sedang melanda kota!");
        setColor(4);
        cout << "1.";
        setColor(7);
        ...
        if (respon == 1)
        {
            cout << "Banjir telah diatasi (-$1500)" << endl;
            uang = uang - 1500;
        }
        if (respon == 2)
        {
            *pendapatan = *pendapatan / 2;
            cout << "Banjir telah menurunkan produktivitas di kotamu (-50'%' penghasilan dalam 1 hari)" << endl;
        }
    }
    ...
    {
        printDengan2GarisBawah("Perhatian !!! Salah satu pabrik di kotamu terbakar! (-1 Pabrik)");
        pabrik = pabrik - 1;
        for (int i = 0; i < 6; i++)
        {
            if (isBreak == true)
    ...
    {
        printDengan2GarisBawah("Perhatian !!! Agus Buntung datang ke kotamu!");
        setColor(4);
        cout << "1.";
        setColor(7);
        ...
        if (respon == 1)
        {
            cout << "Agus Buntung pergi meninggalkan kotamu (-$500)" << endl;
            uang = uang - 500;
        }
        if (respon == 2)
        {
            ...
            cout << "100 orang merasa tidak nyaman sehingga mereka pergi (-1 Rumah)" << endl;
        }
    }
    if (hariEvent[3] == hariTerkini)
    {
        printDengan2GarisBawah("Perhatian !!!! Presiden datang ke kotamu. Apakah ini merupakan pertanda baik? (+$5000)");
        uang = uang + 5000;
    }
}
